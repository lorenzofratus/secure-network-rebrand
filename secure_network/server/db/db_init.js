...
const svs = [
	{
		...
		img: '/images/covers/services/application-security/web-applications-and-web-services.svg',
	...
	},
	{
		...
		img: '/images/covers/services/application-security/mobile-applications.svg',
		category_id: 'application-security',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	...
	},
	{
		...
		img: '/images/covers/services/application-security/software-licensing-and-code-protection.svg',
		category_id: 'application-security',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	{
		...
		img: '/images/covers/services/network-and-infrastructure-security/external-and-internal-network.svg',
	...
	},
	{
		...
		img: '/images/covers/services/network-and-infrastructure-security/wireless-network-and-infrastructure.svg',
		category_id: 'network-security',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	{
		...
		img: '/images/covers/services/network-and-infrastructure-security/corporate-workstation-penetration-test.svg',
		category_id: 'network-security',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	{
		...
		img: '/images/covers/services/network-and-infrastructure-security/virtual-infrastructure.svg',
		category_id: 'network-security',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	...
	“Bit for bit” copy technique and hash calculation of acquired evidence must be implemented by the acquisition process in order to be considered reliable, repeatable and to guarantee the completeness of duplicattion process. Only with proper procedures and a bit for bit copy it is possible to ensure data integrity and maintaining the Chain of Custody (CoC) throughout the whole process.`,
		img: '/images/covers/services/digital-forensics/forensics-acquisition.svg',
	...
	},
	{
		...
		img: '/images/covers/services/digital-forensics/device-analysis.svg',
		category_id: 'digital-forensics',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	...
	},
	{
		...
		img: '/images/covers/services/security-assessments/vulnerability-assessment.svg',
	...
	},
	{
		...
		img: '/images/covers/services/security-assessments/penetration-test.svg',
		category_id: 'security-assessment',
		path: '/services/categories/',
		area_id: 'enterprise-security',
	},
	{
		...
		img: '/images/covers/services/mobile-security-training/mobile-application-security-crash-course.svg',
	...
	},
	{
		...
		img: '/images/covers/services/mobile-security-training/mobile-security-and-mobile-device-management.svg',
		category_id: 'mobile-security-training',
		path: '/services/categories/',
		area_id: 'training',
	},
	{
		...
		img: '/images/covers/services/binary-exploitation-training/reverse-engineering.svg',
	...
	},
	{
		...
		img: '/images/covers/services/binary-exploitation-training/vulnerability-detection-and-exploitation.svg',
		category_id: 'binary-exploitation-training',
		path: '/services/categories/',
		area_id: 'training',
	},
	{
		...
		img: '/images/covers/services/binary-exploitation-training/application-vulnerability-assessment.svg',
		category_id: 'binary-exploitation-training',
		path: '/services/categories/',
		area_id: 'training',
	},
	{
		...
		img: '/images/covers/services/web-exploitation-training/network-vulnerability-assessment.svg',
	...
	},
	{
		...
		img: '/images/covers/services/web-exploitation-training/network-penetration-testing.svg',
		category_id: 'web-exploitation-training',
		path: '/services/categories/',
		area_id: 'training',
	},
	{
		...
		img: '/images/covers/services/web-exploitation-training/web-application-testing.svg',
		category_id: 'web-exploitation-training',
		path: '/services/categories/',
		area_id: 'training',
	},
...
const art = [
	{
		...
		text: `Nick Skelsey, Security Engineer, presents <a target="_blank" rel="noopener noreferrer" href="https://github.com/nskelsey/monopticon">his work</a> visualizing network traffic along with an introduction to Zeek at <a target="_blank" rel="noopener noreferrer" href="https://infosek.net/en/lectures#299">Infosek 2019</a> in Nova Gorica, Solvenia.\n
		His focus is to provide a simple interface to quickly visualize the networks a penetration tester is operating in.
		The PDF slides of the presentation can be downloaded <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2020-08_BlackHatUS_OTRazor.pdf">here</a>.
		`,
	},
	{
		type: 'research',
		...
		text: `Nick Skelsey, Security Engineer, presents <a target="_blank" rel="noopener noreferrer" href="https://github.com/nskelsey/monopticon">his work</a> visualizing network traffic along with an introduction to Zeek at <a target="_blank" rel="noopener noreferrer" href="https://infosek.net/en/lectures#299">Infosek 2019</a> in Nova Gorica, Solvenia.\n
		His focus is to provide a simple interface to quickly visualize the networks a penetration tester is operating in.\n
		The PDF slides of the presentation can be downloaded <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2019-11_Net-Analysis-with-Zeek.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2019-10-11',
		...
		text: `Nick Skelsey, security engineer at Secure Network, presents <a target="_blank" rel="noopener noreferrer" href="https://github.com/nskelsey/monopticon">Monopticon</a> a tool to analyze attacks inside of local networks at <a target="_blank" rel="noopener noreferrer" href="https://www.zeekweek.com">Zeek Week 2019</a> in Seattle, Washington.\n
		The project provides a simple interface to quickly visualize the networks a penetration tester is operating in.\n
		The PDF slides of the presentation can be downloaded <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2019-10_Traffic-Analysis-Monopticon.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2018-10-02',
		...
		The video can be found <a target="_blank" rel="noopener noreferrer" href="https://sector.ca/sessions/heimdall-vulnerable-host-discovery-and-lifecycle-monitoring-toolkit/">HERE</a>`,
	},
	{
		type: 'research',
		date: '2018-01-31',
		...
		text: `On January 31st at the <a target="_blank" rel="noopener noreferrer" href="https://artintoscience.com/">Art Into Science Conference</a> (Austin, TX) Stefano Zanero, President at Secure Network, and Roberto Clapis, Security Engineer at Secure Network, presented “Night of the Living Vulns”.\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2018-01_ACOD_Night-of-the-Living-Vulns.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2018-01-30',
		...
		subtitle: 'Presentation slides now available for download',
		text: `On January 30th at the <a target="_blank" rel="noopener noreferrer" href="https://icsforum.it/">Industrial CyberSecurity Forum</a> (Milan, MI) Alberto Volpatto, CTO at Secure Network, presented “Dissecting SCADA (in)security”.\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2018-01_ICS_Dissecting-Scada-Insecurity.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2017-04-08',
		...
		subtitle: 'Presentation slides now available for download',
		text: `On March 31st at <a target="_blank" rel="noopener noreferrer" href="https://www.blackhat.com/asia-17">BlackHat Asia</a> (Singapore, SG) Roberto Clapis, Security Engineer at Secure Network, presented “Go get my/vulnerabilities”.\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2017-03_blackhatasia_go-get-my-vulnerabilities.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2017-01-12',
		...
		subtitle: 'Presentation slides now available for download',
		text: `On October 22nd at <a target="_blank" rel="noopener noreferrer" href="https://www.h2hc.com.br/h2hc/en/">H2HC 2016</a> (Sao Paulo, BR) Stefano Zanero, President and founder of Secure Network, presented “Risk based secure design of automotive networks”.\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2016-10_H2HC_risk-based-secure-design-of-automotive-networks.pdf">here</a>.`,
	},
	{
		type: 'news',
		date: '2021-04-26',
		...
		text: `We currently have vacancies for Junior Security Engineers to help us grow our team. We require passion, a basic knowledge of information security, programming and general IT architectures. Fluency in both English and Italian is required. For further information, <a target="_blank" rel="noopener noreferrer" href="https://www.bv-tech.it/it/junior-security-engineer-penetration-tester/">here</a> the full job post (in Italian only). Do you want to join us? Send your CV to our recruitment team at <a target="_blank" rel="noopener noreferrer" href="mailto:recruitment@bv-tech.it">recruitment@bv-tech.it</a>!`,
	},
	{
		type: 'news',
		date: '2020-07-08',
	...
	},
	{
		...
		On May 6th at <a target="_blank" rel="noopener noreferrer" href="https://www.hackinbo.it/singolo-relatore.php?id=28">HackInBo Spring edition 2017</a> (Bologna, IT) he presented “GO GET MY/VULNERABILITIES”.\n
	...
	},
	{
		...
		The article dives into the possibility of cyber attack on the Milan city hall. Copy of the newspaper can be found <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/misc/2017-01_mimesi.pdf">here</a>.`,
	},
	{
		type: 'news',
		date: '2017-01-13',
		...
		On March 28th at <a target="_blank" rel="noopener noreferrer" href="https://www.blackhat.com/asia-17/briefings/schedule/index.html#go-get-myvulnerabilities-an-in-depth-analysis-of-go-language-runtime-and-the-new-class-of-vulnerabilities-it-introduces-5392">Black Hat Asia 2017</a> (Singapore) he will present “GO GET MY/VULNERABILITIES”.\n
	...
	},
	{
		...
		On October 8th at <a target="_blank" rel="noopener noreferrer" href="http://www.ipexpoeurope.com/Seminar-Planner/Cyber-Hack/Thursday-08-October-2015/Diving-into-Windows-Mobile-Platforms-App-Security">Cyber Security Europe</a> (London, UK) he will present “Diving into Windows mobile platforms app security!”.\n
	...
	},
	{
		...
		On May 22nd at <a target="_blank" rel="noopener noreferrer" href="https://2015.appsec.eu/conference-program/">AppSecEU</a> (Amsterdam, NL) he will present “Windows phone App Security for Builders and Breakers”, the result of his research on Windows Phone security.\n
	...
	},
	{
		...
		More info about the conference can be found at <a target="_blank" rel="noopener noreferrer" href="http://conference.hitb.org/hitbsecconf2015ams/">this link</a>`,
	},
	{
		type: 'news',
		date: '2015-02-24',
		...
		On March 26th - 27th at <a target="_blank" rel="noopener noreferrer" href="http://www.computerworld.pl/konferencja/semafor2015">SEMAFOR 2015</a> (Warsaw, PL) he will talk about Windows Phone security, with a particular focus on application security.`,
	},
	{
		type: 'news',
		date: '2015-02-11',
	...
	},
	{
		...
		subtitle: 'Presentation slides now available for download',
		text: `On October 21st at <a target="_blank" rel="noopener noreferrer" href="http://www.smau.it/milano15/schedules/the-dark-ages-of-iot-security/">SMAU 2015</a> (Milan, IT) Stefano Zanero, President and founder of Secure Network, presented “The Dark Ages of IoT Security”.\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2015-10_smau2015_the-dark-ages-of-iot-security.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2015-07-20',
		...
		subtitle: 'Presentation slides now available for download',
		text: `On July 8th at <a target="_blank" rel="noopener noreferrer" href="http://www.dimva2015.it/program.html">DIMVA 2015 Workshop</a> (Milano, IT) Alberto Volpatto, Security Engineer &amp; Team Leader of Secure Network, presented “Down the SCADA (security) Rabbit Hole”\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2015-07_down-the-scada-security-rabbit-hole.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2015-05-29',
		...
		text: `On May 29nd at <a target="_blank" rel="noopener noreferrer" href="http://conference.hitb.org/hitbsecconf2015ams/sessions/windows-phone-freakshow/">HiTB 2015</a> (Amsterdam, NL) Luca De Fulgentis, CTO of Secure Network, presented “The Windows Phone Freakshow”, the result of his latest research on Windows Phone security\n
		Presentation slides in PDF format are now available for download <a target="_blank" rel="noopener noreferrer" href="https://conference.hitb.org/hitbsecconf2015ams/wp-content/uploads/2015/02/D2T1-Luca-De-Fulgentis-The-Windows-Phone-Freakshow.pdf">here</a>.\n
		The research whitepaper in PDF format is available <a target="_blank" rel="noopener noreferrer" href="https://conference.hitb.org/hitbsecconf2015ams/wp-content/uploads/2015/02/WHITEPAPER-The-Windows-Phone-Freakshow.pdf">here</a>.`,
	},
	{
		type: 'research',
		date: '2015-05-08',
		...
		<a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/advisory/SN-15-02_eFront.pdf">SN-15-02</a>: multiple high-impact vulnerabilities have been identified in eFront version 3.6.15, which could lead to critical confidentiality violations and data theft or disruption.`,
	},
	{
		type: 'research',
		date: '2015-06-06',
		...
		Presentation slides in PDF format version are now available for download <a target="_blank" rel="noopener noreferrer" href="https://www.securenetwork.it/docs/talks/2015-01_Tetcon-Saigon-2015.pdf">here</a>.`,
	},
]
