...
\begin{figure}[H]
	...
	\includegraphics[width=0.45\textwidth]{high_fid_wireframes/article/2.png}
...
After reading that article, she goes back to the \emph{Articles} page using the breadcrumbs on top and she selects the year \emph{2017}.
\\
\noindent
Once on the year page, she filters the articles to see only the news and then she finds the interview that she was looking for.
