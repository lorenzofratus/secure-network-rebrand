...
\end{itemize}
\noindent
At the beginning, the chatbot introduce itself and then the user is asked whether *he wants to see all service categories or *he wants to contact the company.
If the user wants to explore categories, the chatbot shows the given page otherwise it shows the contact form.
\\If the user has choosen to explore categories the bot then asks if *he wants to select a specific one, or to proceed to the contact form.
...
\\Once a category is choosen, the bot shows the category page, and then again asks the user if *he wants to select a specific service among those that belong to the 
...
Upon selecting a service, the bot shows the service page and then waits the user input to automatically redirect *he to the contact form. The interaction with the user always ends 
